...
class MNIST_LeNet_Autoencoder(BaseNet):
    ...
    def __init__(self):
        ...
        self.bn2d7 = nn.BatchNorm2d(16, eps=1e-04, affine=False)
        self.deconv5 = nn.ConvTranspose2d(16, 3, 5, bias=False, padding=2)
        nn.init.xavier_uniform_(self.deconv5.weight, gain=nn.init.calculate_gain('leaky_relu'))

        self.bn2d8 = nn.BatchNorm2d(3, eps=1e-04, affine=False)
        self.deconv6 = nn.ConvTranspose2d(3, 3, 5, bias=False, padding=2)
